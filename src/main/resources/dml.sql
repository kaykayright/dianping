...
insert into shop(id,name,created_at,updated_at,remark_score,price_per_man,longtitude,latitude,category_id,tags,start_time,end_time,address,seller_id,icon_url)
