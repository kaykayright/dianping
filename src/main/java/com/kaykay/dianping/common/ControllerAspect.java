 ...
 * @author: hk
 * @Descripiton:
 * @Date: Created in 3:12 下午 2021/12/29.
 * @Modified By:
 */

import com.kaykay.dianping.controller.admin.AdminController;
 ...
 *
 * @author hk
 * @version Id: ControllerAspect.java, v 0.1 2021/12/29 3:12 下午 Exp $$
 */
@Aspect
@Configuration
public class ControllerAspect {
    ...
    @Around("execution(* com.kaykay.dianping.controller.admin.*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
